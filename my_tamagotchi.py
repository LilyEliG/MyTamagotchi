...
class Pet:
    ...
    def age_up(self) -> None:
        """Changes the life stage of the pet"""
    ...
    def time_step(self) -> str:
        """Randomly chooses between fullnes, happiness and cleanliness to decrease by 1"""
...
class TamagotchiGame:
    ...
    def run(self) -> None:
        ...
        while state != "dead":
            ...
            print("fullness", self.pet.fullness)
            print("happiness", self.pet.happiness)
            print("cleanliness", self.pet.cleanliness, '\n')
